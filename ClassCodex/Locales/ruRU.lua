...
L["settings.label.gear_ticks"] = "Показывать отметки этапов улучшения"
L["settings.hint.gear_ticks"] =
    "Отметки показывают этап улучшения надетого предмета в каждом слоте лучшей экипировки. Зелёная отметка означает совпадение с рекомендованным этапом. Жёлтая отметка означает этап ниже рекомендованного."
L["settings.tooltip.gear_ticks"] =
    "Помечает каждую строку лучшей экипировки этапом улучшения надетого предмета. Зелёная отметка означает совпадение с рекомендованным этапом. Жёлтая отметка означает, что предмет лучшей экипировки надет, но его этап ниже рекомендованного. Каждая панель запоминает выбор отдельно."
L["settings.hint.gear_source_no_icons"] = "Отображается в режимах таблицы и списка."
...
L["stat_targets.bin_picker"] =
    "Выберите, из каких игроков берутся цели. Топ 20%, 50% или 80% по экипировке. Выберите, показывать ли в строках значения или проценты."
L["settings.value.stat_targets_values"] = "Значения"
L["settings.value.stat_targets_percent"] = "Проценты"
...
L["talent_apply.saving"] = "Сохранение раскладки «%s»..."
L["talent_apply.save_in_progress"] =
    "Сохранение раскладки уже идёт. Дождитесь завершения."
L["talent_apply.unsaved_changes_save"] =
    "У вас есть несохранённые изменения талантов. Откройте панель талантов и нажмите «Подтвердить изменения» (или щёлкните правой кнопкой по названию раскладки, чтобы отменить их) перед сохранением раскладки."
L["talent_apply.apply_needed"] =
    "Раскладка «%s» ожидает подтверждения. Откройте окно талантов и нажмите «Подтвердить изменения», чтобы завершить сохранение."
