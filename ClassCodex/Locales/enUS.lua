...
L["bis.help.ugg"] = "U.GG shows the gear the most players run in Mythic+ and Raid this season, ranked by popularity."
...
L["settings.label.float_esc"] = "Close with Escape"
L["settings.tooltip.float_esc"] = "Lets the Escape key close the detached panel."
...
L["settings.tooltip.pin_talent_source"] =
    "Lock the talent pane to your manually selected source. When off, the source follows what you're doing. U.GG shows in dungeons and raids, PvP in arenas and battlegrounds, Icy Veins everywhere else."
...
L["settings.tooltip.float_show_stat_targets"] =
    "Show the Stat Targets section (your live stats vs U.GG stat targets) on the Stats tab when the panel is floating."
...
L["settings.tooltip.priority_display"] =
    "How the Stat Priority line shows the hero and content. Choose icons, labels, or both."
...
L["settings.tooltip.bis_source"] =
    "When to show a footer line on item tooltips noting which hero / context the displayed ranks come from. 'Only when different' surfaces the line only when the resolved hero diverges from the one you're currently playing. A quiet reminder that a pin or panel selection has drifted from in-game state."
...
L["settings.tooltip.dock_theme"] =
    "Class Codex adds a gradient background, border, and ringed icons. Compact drops the background and border. Minimalist shows the label only."
L["settings.tooltip.dock_build_filter"] =
    "Which recommended builds appear in the dock's loadout menu. Show everything, only builds for your current hero talent, or the recommended picks only."
...
L["settings.tooltip.dock_hero_filter"] =
    "Which hero talent the hero build filter matches against. Use the active spec's, or pick a specific hero talent."
L["settings.label.dock_max_width"] = "Max dock width"
L["settings.tooltip.dock_max_width"] =
    "Upper limit for the dock's width. Applies to both the fixed width and auto-width sizing."
...
L["settings.tooltip.dock_background"] =
    "Dock background color at full opacity. Use your class color or a custom color. Class Codex theme only."
...
L["gear.tooltip.catalyst"] = "Catalyzed from:"
...
L["settings.tooltip.dock_hide_in_combat"] =
    "Hide the loadout dock during combat. Talent swaps fail in combat anyway, so hiding it only removes visual noise."
...
L["chat.blizzard_bug_notice"] =
    "|cff66ccff[Class Codex]|r The '%s' error you just saw is a known Blizzard bug. Class Codex didn't cause it. Disable 'Add View Talents to right-click unit menus' in Class Codex settings to stop it."
...
L["context.selector_title"] = "Context"
L["context.selector_hint"] = "Source, content type, hero spec. Click to change."
L["tooltip.open_compendium"] = "Click to open Compendium."
L["talent_pane.compare_hint"] = "Compare your talents and pull the latest builds from our sources."
L["gear.cog_hint"] = "Click to change build or view."
L["trinkets.cog_hint"] = "Click to filter tiers and content."
L["rotation.cog_hint"] = "Click to switch rotation."
L["hint.switch_view"] = "Click to switch view."
L["hint.click_change"] = "Click to change."
L["talents.builds_title"] = "Talent builds"
L["talents.builds_body"] = "Choose raid difficulty and toggle Recommended (the most popular build per boss or dungeon)."
L["card.hero_talent"] = "Hero talent"
L["card.currently_applied"] = "Currently applied"

L["talent_apply.applied"] = "Talents applied: %s"
L["talent_apply.renamed"] = "Renamed loadout to %s"
...
L["talent_apply.inspecting"] = "Cannot apply a build while inspecting another player. Close the inspect first."
L["talent_apply.no_tree"] = "Cannot determine the talent tree."
L["talent_apply.no_config"] = "No active talent configuration."
L["talent_apply.no_slots_use"] = "No free loadout slots. Delete one to use Class Codex builds."
L["talent_apply.no_slots_save"] = "No free loadout slots. Delete one to save a new build."
L["talent_apply.loading"] = "Talent configuration is still loading. Try again in a moment."
L["talent_apply.tree_changed"] = "Talent tree changed while applying. Try again."
L["talent_apply.in_progress"] = "Apply already in progress. Wait for it to finish."
L["talent_apply.empty_export"] = "Empty export string."
L["talent_apply.decode_failed"] = "Failed to decode export string."
L["talent_apply.invalid_export"] = "Invalid export string."
L["talent_apply.bad_export"] = "Bad export string."
L["talent_apply.version_mismatch"] = "Serialization version mismatch."
L["talent_apply.wrong_version"] = "Build string is from a different game version. Re-copy it."
L["talent_apply.spec_mismatch"] = "Export is for spec %d, active is %d."
...
L["talent_apply.not_settled"] =
    "Talent apply did not settle after %s attempts. The config system is busy. Try again in a moment."
...
L["talent_apply.name_required"] = "Loadout name is required."
L["talent_apply.name_reserved"] = '"%s" is reserved for Class Codex. Pick a different name.'
L["talent_apply.save_failed"] = "Couldn't save the loadout. Check the build string."
L["talent_apply.import_unsupported"] = "Import not supported by this client."
L["talent_apply.save_unsupported"] = "This game version doesn't support saving loadouts."
L["talent_apply.apis_unavailable"] = "Required talent APIs not available."
L["talent_apply.import_failed"] = "Import failed."
L["talent_apply.failed_generic"] = "Failed to apply talents."

L["chat.commands_header"] = "commands:"
L["error.panel"] = "Panel error: %s"
L["error.no_talent_config"] = "No active talent config. Open the talents pane first."
L["error.no_tree_spec"] = "Could not resolve tree or spec."
L["dungeon.journal_unavailable"] = "Journal loot index unavailable (journal API missing)."
L["dungeon.journal_build_failed"] = "Journal loot index build failed: %s"
L["dungeon.journal_empty"] = "Journal loot index built empty. Journal difficulty may hide loot."
